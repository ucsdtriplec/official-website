<template>
  <div>
    ...
    <!-- WARNING: ALL THE TEXT IN THIS SECTION IS PLACEHOLDER -->
    <section>
          ...
          <v-container grid-list-xl>
            <v-layout row wrap align-start>
              <v-flex xs12 md4>
                <v-card class="elevation-0 transparent">
                  ...
                  <v-card-text>
                    ...
                    <a href="/workshop" class="blue--text"> Learn more </a>
                  </v-card-text>
                </v-card>
              </v-flex>
              <v-flex xs12 md4>
              ...
              <v-flex xs12 md4>
                <v-card class="elevation-0 transparent">
                  <v-card-text class="text-center">
                    <v-icon x-large class="red--text text--darken-1 text--lighten-2">
                      mdi-account-group
                    </v-icon>
                  </v-card-text>
                  <v-card-title primary-title class="layout justify-center">
